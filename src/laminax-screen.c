 ...
 * We should use new api when possible, especially in core Laminax js.
 */
...
G_DEFINE_TYPE (LaminaxScreen, Laminax_screen, G_TYPE_OBJECT);

static void
Laminax_screen_set_property (GObject      *object,
                          guint         prop_id,
                          const GValue *value,
                          GParamSpec   *pspec)
{
  LaminaxScreen *screen = Laminax_SCREEN (object);
...
static void
Laminax_screen_get_property (GObject      *object,
                          guint         prop_id,
                          GValue       *value,
                          GParamSpec   *pspec)
{
...
static void
Laminax_screen_constructed (GObject *object)
{
  G_OBJECT_CLASS (Laminax_screen_parent_class)->constructed (object);
  LaminaxScreen *screen = Laminax_SCREEN (object);
...
static void
Laminax_screen_finalize (GObject *object)
{
  /* Actual freeing done in Laminax_screen_free() for now */

  G_OBJECT_CLASS (Laminax_screen_parent_class)->finalize (object);
}

static void
Laminax_screen_class_init (LaminaxScreenClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);
  GParamSpec   *pspec;

  object_class->get_property = Laminax_screen_get_property;
  object_class->set_property = Laminax_screen_set_property;
  object_class->constructed = Laminax_screen_constructed;
  object_class->finalize = Laminax_screen_finalize;
...
static void
Laminax_screen_init (LaminaxScreen *screen)
{
}

LaminaxScreen *
Laminax_screen_new (MetaDisplay *display)
{
    return g_object_new (Laminax_TYPE_SCREEN, "display", display, NULL);
}

int
Laminax_screen_get_n_workspaces (LaminaxScreen *screen)
{
  g_return_val_if_fail (Laminax_IS_SCREEN (screen), 1);

  return meta_workspace_manager_get_n_workspaces (screen->ws_manager);
}

/**
 * Laminax_screen_get_workspace_by_index:
 * @screen: a #LaminaxScreen
 ...
 */
MetaWorkspace*
Laminax_screen_get_workspace_by_index (LaminaxScreen  *screen,
                                        int              idx)
{
  g_return_val_if_fail (Laminax_IS_SCREEN (screen), NULL);

  return meta_workspace_manager_get_workspace_by_index (screen->ws_manager, idx);
}

void
Laminax_screen_remove_workspace (LaminaxScreen *screen,
                                  MetaWorkspace  *workspace,
                                  guint32         timestamp)
{
  g_return_if_fail (Laminax_IS_SCREEN (screen));

  meta_workspace_manager_remove_workspace (screen->ws_manager, workspace, timestamp);
}

/**
 * Laminax_screen_append_new_workspace:
 * @screen: a #LaminaxScreen
 ...
 */
MetaWorkspace *
Laminax_screen_append_new_workspace (LaminaxScreen *screen,
                                      gboolean        activate,
                                      guint32         timestamp)
{
  g_return_val_if_fail (Laminax_IS_SCREEN (screen), NULL);
...
/**
 * Laminax_screen_get_mouse_window:
 * @screen: a Laminax-screen.
 ...
 */
MetaWindow*
Laminax_screen_get_mouse_window (LaminaxScreen  *screen,
...
int
Laminax_screen_get_monitor_index_for_rect (LaminaxScreen    *screen,
                                            MetaRectangle *rect)
{
  g_return_val_if_fail (Laminax_IS_SCREEN (screen), 0);

  return meta_display_get_monitor_index_for_rect (screen->display, rect);
}

/**
 * Laminax_screen_get_current_monitor:
 * @screen: a #LaminaxScreen
 *
 ...
 */
int
Laminax_screen_get_current_monitor (LaminaxScreen *screen)
{
  g_return_val_if_fail (Laminax_IS_SCREEN (screen), 0);
 ...
 */
int
Laminax_screen_get_n_monitors (LaminaxScreen *screen)
{
  g_return_val_if_fail (Laminax_IS_SCREEN (screen), 1);
...
/**
 * Laminax_screen_get_primary_monitor:
 * @screen: a #LaminaxScreen
 *
 ...
 */
int
Laminax_screen_get_primary_monitor (LaminaxScreen *screen)
{
  g_return_val_if_fail (Laminax_IS_SCREEN (screen), 0);
...
/**
 * Laminax_screen_get_monitor_geometry:
 * @screen: a #LaminaxScreen
 ...
 */
void
Laminax_screen_get_monitor_geometry (LaminaxScreen    *screen,
                                      int                monitor,
...
/**
 * Laminax_screen_override_workspace_layout:
 * @screen: a #LaminaxScreen
 ...
 */
void
Laminax_screen_override_workspace_layout (LaminaxScreen      *screen,
...
void
Laminax_screen_toggle_desktop (LaminaxScreen *screen,
                                guint32         timestamp)
{
...
void
Laminax_screen_show_desktop (LaminaxScreen *screen,
                              guint32         timestamp)
{
...
void
Laminax_screen_unshow_desktop (LaminaxScreen *screen)
{
  meta_workspace_manager_unshow_desktop (screen->ws_manager);
}

/**
 * Laminax_screen_get_display:
 ...
 */
MetaDisplay *
Laminax_screen_get_display (LaminaxScreen *screen)
{
  g_return_val_if_fail (Laminax_IS_SCREEN (screen), NULL);
 ...
 */
void
Laminax_screen_get_size (LaminaxScreen *screen,
                      int        *width,
                      int        *height)
{
  g_return_if_fail (Laminax_IS_SCREEN (screen));
...
/**
 * Laminax_screen_get_workspaces: (skip)
 * @screen: a #LaminaxScreen
 *
 * Returns: (transfer none) (element-type Meta.Workspace): The workspaces for @screen
 */
GList *
Laminax_screen_get_workspaces (LaminaxScreen *screen)
{
  g_return_val_if_fail (Laminax_IS_SCREEN (screen), NULL);
...
int
Laminax_screen_get_active_workspace_index (LaminaxScreen *screen)
{
  g_return_val_if_fail (Laminax_IS_SCREEN (screen), 0);
...
/**
 * Laminax_screen_get_active_workspace:
 *
 * Returns: (transfer none): The current workspace
 */
MetaWorkspace *
Laminax_screen_get_active_workspace (LaminaxScreen *screen)
{
  g_return_val_if_fail (Laminax_IS_SCREEN (screen), NULL);
...
/**
 * Laminax_screen_get_monitor_in_fullscreen:
 * @screen: a #LaminaxScreen
 * @monitor: the monitor number
 *
 ...
 * LaminaxScreen::in-fullscreen-changed.
 *
 * Returns: %TRUE if there is a fullscreen window covering the specified monitor.
 */
gboolean
Laminax_screen_get_monitor_in_fullscreen (LaminaxScreen  *screen,
                                       int          monitor)
{
  g_return_val_if_fail (Laminax_IS_SCREEN (screen), FALSE);
...
unsigned long
Laminax_screen_get_xwindow_for_window (LaminaxScreen *screen,
                                        MetaWindow     *window)
{
  g_return_val_if_fail (Laminax_IS_SCREEN (screen), 0);
