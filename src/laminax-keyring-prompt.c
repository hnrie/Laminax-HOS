...
#include "Laminax-keyring-prompt.h"
#include "Laminax-secure-text-buffer.h"
...
typedef struct _LaminaxPasswordPromptPrivate  LaminaxPasswordPromptPrivate;
...
static void Laminax_keyring_prompt_iface (GcrPromptIface *iface);

G_DEFINE_TYPE_WITH_CODE (LaminaxKeyringPrompt, Laminax_keyring_prompt, G_TYPE_OBJECT,
                         G_IMPLEMENT_INTERFACE (GCR_TYPE_PROMPT, Laminax_keyring_prompt_iface);
);
...
static void
Laminax_keyring_prompt_init (LaminaxKeyringPrompt *self)
{
...
static void
Laminax_keyring_prompt_set_property (GObject      *obj,
                                      guint         prop_id,
                                      const GValue *value,
                                      GParamSpec   *pspec)
{
  LaminaxKeyringPrompt *self = Laminax_KEYRING_PROMPT (obj);
  ...
  case PROP_PASSWORD_ACTOR:
    Laminax_keyring_prompt_set_password_actor (self, g_value_get_object (value));
    break;
  case PROP_CONFIRM_ACTOR:
    Laminax_keyring_prompt_set_confirm_actor (self, g_value_get_object (value));
    break;
  default:
...
static void
Laminax_keyring_prompt_get_property (GObject    *obj,
                                      guint       prop_id,
                                      GValue     *value,
                                      GParamSpec *pspec)
{
  ...
  case PROP_CHOICE_VISIBLE:
    ...
    break;
  case PROP_PASSWORD_ACTOR:
    g_value_set_object (value, Laminax_keyring_prompt_get_password_actor (self));
    break;
  case PROP_CONFIRM_ACTOR:
    g_value_set_object (value, Laminax_keyring_prompt_get_confirm_actor (self));
    break;
  default:
    G_OBJECT_WARN_INVALID_PROPERTY_ID (obj, prop_id, pspec);
    break;
...
static void
Laminax_keyring_prompt_dispose (GObject *obj)
{
  LaminaxKeyringPrompt *self = Laminax_KEYRING_PROMPT (obj);
  ...
  if (self->task)
    Laminax_keyring_prompt_cancel (self);
  g_assert (self->task == NULL);

  Laminax_keyring_prompt_set_password_actor (self, NULL);
  Laminax_keyring_prompt_set_confirm_actor (self, NULL);

  G_OBJECT_CLASS (Laminax_keyring_prompt_parent_class)->dispose (obj);
}

static void
Laminax_keyring_prompt_finalize (GObject *obj)
{
  LaminaxKeyringPrompt *self = Laminax_KEYRING_PROMPT (obj);
  ...
  G_OBJECT_CLASS (Laminax_keyring_prompt_parent_class)->finalize (obj);
}

static void
Laminax_keyring_prompt_class_init (LaminaxKeyringPromptClass *klass)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (klass);

  gobject_class->get_property = Laminax_keyring_prompt_get_property;
  gobject_class->set_property = Laminax_keyring_prompt_set_property;
  gobject_class->dispose = Laminax_keyring_prompt_dispose;
  gobject_class->finalize = Laminax_keyring_prompt_finalize;
  ...
  /**
   * LaminaxKeyringPrompt:password-visible:
   *
  ...
  /**
    * LaminaxKeyringPrompt:confirm-visible:
    *
  ...
  /**
   * LaminaxKeyringPrompt:warning-visible:
   *
  ...
  /**
   * LaminaxKeyringPrompt:choice-visible:
   *
  ...
  /**
   * LaminaxKeyringPrompt:password-actor:
   *
  ...
  /**
   * LaminaxKeyringPrompt:confirm-actor:
   *
...
static void
Laminax_keyring_prompt_password_async (GcrPrompt          *prompt,
                                        GCancellable       *cancellable,
                                        GAsyncReadyCallback callback,
                                        gpointer            user_data)
{
  LaminaxKeyringPrompt *self = Laminax_KEYRING_PROMPT (prompt);
  GObject *obj;
  ...
  g_task_set_source_tag (self->task, Laminax_keyring_prompt_password_async);
...
static const gchar *
Laminax_keyring_prompt_password_finish (GcrPrompt    *prompt,
                                         GAsyncResult *result,
                                         GError      **error)
{
  g_return_val_if_fail (g_task_get_source_object (G_TASK (result)) == prompt, NULL);
  g_return_val_if_fail (g_async_result_is_tagged (result,
                        Laminax_keyring_prompt_password_async), NULL);

  return g_task_propagate_pointer (G_TASK (result), error);
}

static void
Laminax_keyring_prompt_confirm_async (GcrPrompt          *prompt,
                                       GCancellable       *cancellable,
                                       GAsyncReadyCallback callback,
                                       gpointer            user_data)
{
  ...
  self->task = g_task_new (self, NULL, callback, user_data);
  g_task_set_source_tag (self->task, Laminax_keyring_prompt_confirm_async);
...
Laminax_keyring_prompt_confirm_finish (GcrPrompt    *prompt,
                                        GAsyncResult *result,
                                        GError      **error)
{
  ...
  g_return_val_if_fail (g_async_result_is_tagged (result,
                        Laminax_keyring_prompt_confirm_async), GCR_PROMPT_REPLY_CANCEL);
...
static void
Laminax_keyring_prompt_close (GcrPrompt *prompt)
{
  LaminaxKeyringPrompt *self = Laminax_KEYRING_PROMPT (prompt);
...
static void
Laminax_keyring_prompt_iface (GcrPromptIface *iface)
{
  iface->prompt_password_async = Laminax_keyring_prompt_password_async;
  iface->prompt_password_finish = Laminax_keyring_prompt_password_finish;
  iface->prompt_confirm_async = Laminax_keyring_prompt_confirm_async;
  iface->prompt_confirm_finish = Laminax_keyring_prompt_confirm_finish;
  iface->prompt_close = Laminax_keyring_prompt_close;
}

/**
 * Laminax_keyring_prompt_new:
 *
 * Create new internal prompt base
 *
 * Returns: (transfer full): new internal prompt
 */
LaminaxKeyringPrompt *
Laminax_keyring_prompt_new (void)
{
    return g_object_new (Laminax_TYPE_KEYRING_PROMPT, NULL);
}

/**
 * Laminax_keyring_prompt_get_password_actor:
 ...
 */
ClutterText *
Laminax_keyring_prompt_get_password_actor (LaminaxKeyringPrompt *self)
{
  g_return_val_if_fail (Laminax_IS_KEYRING_PROMPT (self), NULL);
  return self->password_actor;
}

/**
 * Laminax_keyring_prompt_get_confirm_actor:
 * @self: the internal prompt
 *
 * Get the prompt password text actor
 *
 ...
 */
ClutterText *
Laminax_keyring_prompt_get_confirm_actor (LaminaxKeyringPrompt *self)
{
  g_return_val_if_fail (Laminax_IS_KEYRING_PROMPT (self), NULL);
...
on_password_changed (ClutterText *text,
                     gpointer     user_data)
{
  LaminaxKeyringPrompt *self = Laminax_KEYRING_PROMPT (user_data);
...
/**
 * Laminax_keyring_prompt_set_password_actor:
 * @self: the internal prompt
 ...
 */
void
Laminax_keyring_prompt_set_password_actor (LaminaxKeyringPrompt *self,
                                            ClutterText           *password_actor)
{
  ClutterTextBuffer *buffer;

  g_return_if_fail (Laminax_IS_KEYRING_PROMPT (self));
  ...
  if (password_actor)
    {
      buffer = Laminax_secure_text_buffer_new ();
...
/**
 * Laminax_keyring_prompt_set_confirm_actor:
 * @self: the internal prompt
 ...
 */
void
Laminax_keyring_prompt_set_confirm_actor (LaminaxKeyringPrompt *self,
                                           ClutterText           *confirm_actor)
{
  ClutterTextBuffer *buffer;
...
/**
 * Laminax_keyring_prompt_complete:
 * @self: the internal prompt
 *
 ...
 */
gboolean
Laminax_keyring_prompt_complete (LaminaxKeyringPrompt *self)
{
  GTask *res;
  PromptingMode mode;
  const gchar *password;
  ...
  g_return_val_if_fail (Laminax_IS_KEYRING_PROMPT (self), FALSE);
...
/**
 * Laminax_keyring_prompt_cancel:
 * @self: the internal prompt
 *
 * Called by implementation when the prompt is cancelled.
 */
void
Laminax_keyring_prompt_cancel (LaminaxKeyringPrompt *self)
{
  GTask *res;
  PromptingMode mode;
