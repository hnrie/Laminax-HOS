...
G_DEFINE_TYPE (LaminaxMimeSniffer, Laminax_mime_sniffer, G_TYPE_OBJECT);
...
struct _LaminaxMimeSnifferPrivate {
  GFile *file;
...
{
  LaminaxMimeSniffer *self = state->self;
  GArray *results;
...
static void
deep_count_start (LaminaxMimeSniffer *self)
{
  DeepCountState *state;
                           ...
                           gpointer user_data)
{
  GFileInfo *info;
  GError *error = NULL;
  LaminaxMimeSniffer *self = user_data;
...
static void
start_loading_file (LaminaxMimeSniffer *self)
{
...
static void
Laminax_mime_sniffer_set_file (LaminaxMimeSniffer *self,
                            GFile *file)
{
...
static void
Laminax_mime_sniffer_dispose (GObject *object)
{
  LaminaxMimeSniffer *self = Laminax_MIME_SNIFFER (object);
  ...
  G_OBJECT_CLASS (Laminax_mime_sniffer_parent_class)->dispose (object);
}

static void
Laminax_mime_sniffer_finalize (GObject *object)
{
  LaminaxMimeSniffer *self = Laminax_MIME_SNIFFER (object);

  g_strfreev (self->priv->sniffed_mime);

  G_OBJECT_CLASS (Laminax_mime_sniffer_parent_class)->finalize (object);
}

static void
Laminax_mime_sniffer_get_property (GObject *object,
                                guint       prop_id,
                                GValue     *value,
                                GParamSpec *pspec)
{
...
static void
Laminax_mime_sniffer_set_property (GObject *object,
                                guint       prop_id,
                                const GValue *value,
                                GParamSpec *pspec)
{
  ...
  switch (prop_id) {
  case PROP_FILE:
    Laminax_mime_sniffer_set_file (self, g_value_get_object (value));
    break;
  default:
    G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
    break;
...
static void
Laminax_mime_sniffer_class_init (LaminaxMimeSnifferClass *klass)
{
  GObjectClass *oclass;

  oclass = G_OBJECT_CLASS (klass);
  oclass->dispose = Laminax_mime_sniffer_dispose;
  oclass->finalize = Laminax_mime_sniffer_finalize;
  oclass->get_property = Laminax_mime_sniffer_get_property;
  oclass->set_property = Laminax_mime_sniffer_set_property;
  ...
  g_type_class_add_private (klass, sizeof (LaminaxMimeSnifferPrivate));
  g_object_class_install_properties (oclass, NUM_PROPERTIES, properties);
}

static void
Laminax_mime_sniffer_init (LaminaxMimeSniffer *self)
{
  self->priv =
    G_TYPE_INSTANCE_GET_PRIVATE (self,
                                 Laminax_TYPE_MIME_SNIFFER,
                                 LaminaxMimeSnifferPrivate);
  init_mimetypes ();
}

LaminaxMimeSniffer *
Laminax_mime_sniffer_new (GFile *file)
{
  return g_object_new (Laminax_TYPE_MIME_SNIFFER,
                       "file", file,
                       NULL);
}

void
Laminax_mime_sniffer_sniff_async (LaminaxMimeSniffer *self,
                                ...
                                gpointer user_data)
{
  ...
  self->priv->async_result =
    g_simple_async_result_new (G_OBJECT (self),
                               callback, user_data,
                               Laminax_mime_sniffer_sniff_finish);
...
gchar **
Laminax_mime_sniffer_sniff_finish (LaminaxMimeSniffer *self,
                                 GAsyncResult *res,
                                 GError **error)
{
