...
#include "Laminax-polkit-authentication-agent.h"
...
print_debug (const gchar *format, ...)
{
  ...
  g_print ("LaminaxPolkitAuthenticationAgent: %s.%03d: %s\n",
...
struct _LaminaxPolkitAuthenticationAgent {
...
G_DEFINE_TYPE (LaminaxPolkitAuthenticationAgent, Laminax_polkit_authentication_agent, POLKIT_AGENT_TYPE_LISTENER);
...
void
Laminax_polkit_authentication_agent_init (LaminaxPolkitAuthenticationAgent *agent)
{
}

gchar *
Laminax_polkit_authentication_agent_register (LaminaxPolkitAuthenticationAgent *agent,
                                            GError                        **error_out)
{
  GError *error = NULL;
...
static void
Laminax_polkit_authentication_agent_finalize (GObject *object)
{
  LaminaxPolkitAuthenticationAgent *agent = Laminax_POLKIT_AUTHENTICATION_AGENT (object);
  Laminax_polkit_authentication_agent_unregister (agent);
  G_OBJECT_CLASS (Laminax_polkit_authentication_agent_parent_class)->finalize (object);
}

static void
Laminax_polkit_authentication_agent_class_init (LaminaxPolkitAuthenticationAgentClass *klass)
{
  GObjectClass *gobject_class;
  PolkitAgentListenerClass *listener_class;

  gobject_class = G_OBJECT_CLASS (klass);
  gobject_class->finalize = Laminax_polkit_authentication_agent_finalize;
...
LaminaxPolkitAuthenticationAgent *
Laminax_polkit_authentication_agent_new (void)
{
  return Laminax_POLKIT_AUTHENTICATION_AGENT (g_object_new (Laminax_TYPE_POLKIT_AUTHENTICATION_AGENT, NULL));
}

struct _AuthRequest {
  /* not holding ref */
  LaminaxPolkitAuthenticationAgent *agent;
  GCancellable *cancellable;
  gulong handler_id;
                      ...
                      gpointer      user_data)
{
  ...
  g_source_set_name_by_id (id, "[Laminax] handle_cancelled_in_idle");
}
...
void
Laminax_polkit_authentication_agent_unregister (LaminaxPolkitAuthenticationAgent *agent)
{
...
static void maybe_process_next_request (LaminaxPolkitAuthenticationAgent *agent);

static void
auth_request_complete (AuthRequest *request,
                       gboolean     dismissed)
{
  LaminaxPolkitAuthenticationAgent *agent = request->agent;
...
static void
maybe_process_next_request (LaminaxPolkitAuthenticationAgent *agent)
{
...
initiate_authentication (PolkitAgentListener  *listener,
                         ...
                         gpointer              user_data)
{
  LaminaxPolkitAuthenticationAgent *agent = Laminax_POLKIT_AUTHENTICATION_AGENT (listener);
  AuthRequest *request;
...
void
Laminax_polkit_authentication_agent_complete (LaminaxPolkitAuthenticationAgent *agent,
                                            gboolean                        dismissed)
{
  g_return_if_fail (Laminax_IS_POLKIT_AUTHENTICATION_AGENT (agent));
