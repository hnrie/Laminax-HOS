...
/* Laminax-perf-helper: a program to create windows for performance tests
 *
...
#define BUS_NAME "org.Laminax.PerfHelper"
...
static const gchar introspection_xml[] =
	  "<node>"
	  "  <interface name='org.Laminax.PerfHelper'>"
	  "    <method name='Exit'/>"
...
main (int argc, char **argv)
{
  ...
  /* Since we depend on this, avoid the possibility of lt-Laminax-perf-helper */
  g_set_prgname ("Laminax-perf-helper");
