...
/* Laminax-secure-text-buffer.c - secure memory clutter text buffer
...
struct _LaminaxSecureTextBuffer {
...
G_DEFINE_TYPE (LaminaxSecureTextBuffer, Laminax_secure_text_buffer, CLUTTER_TYPE_TEXT_BUFFER);

static const gchar *
Laminax_secure_text_buffer_real_get_text (ClutterTextBuffer *buffer,
                                           gsize             *n_bytes)
{
  LaminaxSecureTextBuffer *self = Laminax_SECURE_TEXT_BUFFER (buffer);
  if (n_bytes)
...
static guint
Laminax_secure_text_buffer_real_get_length (ClutterTextBuffer *buffer)
{
  LaminaxSecureTextBuffer *self = Laminax_SECURE_TEXT_BUFFER (buffer);
...
static guint
Laminax_secure_text_buffer_real_insert_text (ClutterTextBuffer *buffer,
                                              guint              position,
                                              const gchar       *chars,
                                              guint              n_chars)
{
...
static guint
Laminax_secure_text_buffer_real_delete_text (ClutterTextBuffer *buffer,
                                              guint              position,
                                              guint              n_chars)
{
  LaminaxSecureTextBuffer *self = Laminax_SECURE_TEXT_BUFFER (buffer);
...
static void
Laminax_secure_text_buffer_init (LaminaxSecureTextBuffer *self)
{

}

static void
Laminax_secure_text_buffer_finalize (GObject *obj)
{
  LaminaxSecureTextBuffer *self = Laminax_SECURE_TEXT_BUFFER (obj);
  ...
  G_OBJECT_CLASS (Laminax_secure_text_buffer_parent_class)->finalize (obj);
}

static void
Laminax_secure_text_buffer_class_init (LaminaxSecureTextBufferClass *klass)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (klass);
  ClutterTextBufferClass *buffer_class = CLUTTER_TEXT_BUFFER_CLASS (klass);

  gobject_class->finalize = Laminax_secure_text_buffer_finalize;

  buffer_class->get_text = Laminax_secure_text_buffer_real_get_text;
  buffer_class->get_length = Laminax_secure_text_buffer_real_get_length;
  buffer_class->insert_text = Laminax_secure_text_buffer_real_insert_text;
  buffer_class->delete_text = Laminax_secure_text_buffer_real_delete_text;
}

ClutterTextBuffer *
Laminax_secure_text_buffer_new (void)
{
  return g_object_new (Laminax_TYPE_SECURE_TEXT_BUFFER, NULL);
}
