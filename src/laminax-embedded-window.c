 ...
 * LaminaxGtkEmbed; the resizing logic is bound to the clutter logic.
 *
 * The typical usage we might expect is
 *
 *  - LaminaxEmbeddedWindow is created and filled with content
 *  - LaminaxEmbeddedWindow is shown with gtk_widget_show_all()
 *  - LaminaxGtkEmbed is created for the LaminaxEmbeddedWindow
...
typedef struct _LaminaxEmbeddedWindowPrivate LaminaxEmbeddedWindowPrivate;

struct _LaminaxEmbeddedWindowPrivate {
  LaminaxGtkEmbed *actor;

  GdkRectangle position;
};

G_DEFINE_TYPE_WITH_PRIVATE (LaminaxEmbeddedWindow,
                            Laminax_embedded_window,
                            GTK_TYPE_WINDOW);
 ...
 */
static void
Laminax_embedded_window_show (GtkWidget *widget)
{
  LaminaxEmbeddedWindow *window = Laminax_EMBEDDED_WINDOW (widget);
  LaminaxEmbeddedWindowPrivate *priv;
  GtkWidgetClass *widget_class;

  priv = Laminax_embedded_window_get_instance_private (window);
...
static void
Laminax_embedded_window_hide (GtkWidget *widget)
{
  LaminaxEmbeddedWindow *window = Laminax_EMBEDDED_WINDOW (widget);
  LaminaxEmbeddedWindowPrivate *priv;
  ...
  GTK_WIDGET_CLASS (Laminax_embedded_window_parent_class)->hide (widget);
}

static gboolean
Laminax_embedded_window_configure_event (GtkWidget         *widget,
...
static void
Laminax_embedded_window_check_resize (GtkContainer *container)
{
  LaminaxEmbeddedWindow *window = Laminax_EMBEDDED_WINDOW (container);
  LaminaxEmbeddedWindowPrivate *priv;
...
static GObject *
Laminax_embedded_window_constructor (GType                  gtype,
                                   guint                  n_properties,
                                   GObjectConstructParam *properties)
{
  ...
  parent_class = G_OBJECT_CLASS (Laminax_embedded_window_parent_class);
...
static void
Laminax_embedded_window_class_init (LaminaxEmbeddedWindowClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);
  GtkWidgetClass *widget_class = GTK_WIDGET_CLASS (klass);
  GtkContainerClass *container_class = GTK_CONTAINER_CLASS (klass);

  object_class->constructor     = Laminax_embedded_window_constructor;

  widget_class->show            = Laminax_embedded_window_show;
  widget_class->hide            = Laminax_embedded_window_hide;
  widget_class->configure_event = Laminax_embedded_window_configure_event;

  container_class->check_resize    = Laminax_embedded_window_check_resize;
}

static void
Laminax_embedded_window_init (LaminaxEmbeddedWindow *window)
{
}

/*
 * Private routines called by LaminaxGtkEmbed
 */

void
_Laminax_embedded_window_set_actor (LaminaxEmbeddedWindow  *window,
                                  LaminaxGtkEmbed        *actor)

{
  LaminaxEmbeddedWindowPrivate *priv;

  g_return_if_fail (Laminax_IS_EMBEDDED_WINDOW (window));
...
void
_Laminax_embedded_window_allocate (LaminaxEmbeddedWindow *window,
                                 int                  x,
                                 int                  y,
                                 int                  width,
                                 int                  height)
...
void
_Laminax_embedded_window_map (LaminaxEmbeddedWindow *window)
{
  g_return_if_fail (Laminax_IS_EMBEDDED_WINDOW (window));
...
void
_Laminax_embedded_window_unmap (LaminaxEmbeddedWindow *window)
{
  g_return_if_fail (Laminax_IS_EMBEDDED_WINDOW (window));
 ...
 */
GtkWidget *
Laminax_embedded_window_new (void)
{
  return g_object_new (Laminax_TYPE_EMBEDDED_WINDOW,
                       NULL);
}
