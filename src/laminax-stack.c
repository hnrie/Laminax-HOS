...
/**
 * SECTION:Laminax-stack
 * @short_description: Pure "Z-axis" container class
 *
 * A #LaminaxStack draws its children on top of each other,
...
#include "Laminax-stack.h"

G_DEFINE_TYPE (LaminaxStack,
               Laminax_stack,
               ST_TYPE_WIDGET);

static void
Laminax_stack_allocate (ClutterActor           *self,
...
static void
Laminax_stack_get_preferred_height (ClutterActor *actor,
                                     gfloat for_width,
                                     gfloat *min_height_p,
...
static void
Laminax_stack_get_preferred_width (ClutterActor *actor,
                                 gfloat for_height,
                                 gfloat *min_width_p,
...
static gboolean
Laminax_stack_navigate_focus (StWidget         *widget,
                            ClutterActor     *from,
...
static void
Laminax_stack_class_init (LaminaxStackClass *klass)
{
  ClutterActorClass *actor_class = CLUTTER_ACTOR_CLASS (klass);
  StWidgetClass *widget_class = ST_WIDGET_CLASS (klass);

  actor_class->get_preferred_width = Laminax_stack_get_preferred_width;
  actor_class->get_preferred_height = Laminax_stack_get_preferred_height;
  actor_class->allocate = Laminax_stack_allocate;

  widget_class->navigate_focus = Laminax_stack_navigate_focus;
}

static void
Laminax_stack_init (LaminaxStack *actor)
{
}
