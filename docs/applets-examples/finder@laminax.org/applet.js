...
FileResultButton.prototype =
{
    ...
    _init: function(applet, result, type, custom_label)
    {
        ...
        try
        {
            let icon = Laminax.util_get_icon_for_uri(this._filename);
            if (icon)
            {
...
MyApplet.prototype =
{
    ...
    _init: function(orientation, panel_height, instanceId)
    {
        try
        {
            ...
            this.settings = new AppletSettings(this, "finder@Laminax.org", instanceId);
            ...
            this._appSys = Laminax.AppSystem.get_default();
