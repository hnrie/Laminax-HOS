...
def get_type_link(typ, file):
    ...
    if typ == '':
        ...
        if typ in objects:
            return "Laminax-js-" + objects[typ].prefix
        elif file.name + "." + typ in objects:
            return "Laminax-js-" + objects[file.name + "." + typ].prefix
        elif typ.endswith("s") and typ[:-1] in objects:
            return "Laminax-js-" + objects[typ[:-1]].prefix
        elif typ.endswith("s") and file.name + "." + typ[:-1] in objects:
            return "Laminax-js-" + objects[file.name + "." + typ[:-1]].prefix
...
def markup(line, obj):
    ...
    def format_ext_link(match):
        ...
        if thing in prop_names and not full.endswith("()"):
            return '<link linkend="Laminax-js-{prefix}--{thing}"><code>{full}</code></link>'.format(
...
SGML_CHAPTER_FORMAT = '''
<chapter id="Laminax-js-{prefix}-section">
  <title>{title}</title>
  {entries}
</chapter>'''
...
<refentry id="Laminax-js-{prefix}">
  <refmeta>
    <refentrytitle role="top_of_page" id="Laminax-js-{prefix}.top_of_page">{name}</refentrytitle>
...
<refsect1 id="Laminax-js-{prefix}.functions" role="functions_proto">
...
<row>
  ...
  <entry role="function_name">
    <link linkend="Laminax-js-{prefix}-{name}">{name}</link>&#160;<phrase role="c_punctuation">()</phrase>
  </entry>
</row>
'''

PROPERTY_HEADER_FORMAT = '''
<refsect1 id="Laminax-js-{prefix}.properties" role="properties">
...
<refsect1 id="Laminax-js-{prefix}.signals" role="signal_proto">
...
<row>
  ...
  <entry role="signal_name">
    <link linkend="Laminax-js-{prefix}-{name}-signal">{name}</link>
  </entry>
</row>
'''

ENUM_HEADER_FORMAT = '''
<refsect1 id="Laminax-js-{prefix}.other" role="other_proto">
...
<row>
  ...
  <entry role="function_name">
    <link linkend="Laminax-js-{prefix}-{name}">{name}</link>
  </entry>
</row>
'''
...
HIERARCHY_FORMAT = '''
<refsect1 id="Laminax-js-{prefix}.object-hierarchy" role="object_hierarchy">
...
HIERARCHY_ITEM_FORMAT = '{spacing}<phrase role="lineart">&#9584;&#9472;&#9472;</phrase> <link linkend="Laminax-js-{prefix}">{name}</link>'

DESCRIPTION_FORMAT = '''
<refsect1 id="Laminax-js-{prefix}.description" role="desc">
...
FUNCTIONS_FORMAT = '''
<refsect1 id="Laminax-js-{prefix}.functions_details" role="details">
...
<refsect2 id="Laminax-js-{prefix}-{name}" role="function">
  <title>{name}&#160;()</title>
  <indexterm zone="Laminax-js-{prefix}-{name}"><primary>{name}</primary></indexterm>
...
SIGNALS_FORMAT = '''
<refsect1 id="Laminax-js-{prefix}.signal-details" role="details">
...
SIGNAL_ITEM_FORMAT = '''
<refsect2 id="Laminax-js-{prefix}-{name}-signal" role="signal">
  <title>The <literal>“{name}”</literal> signal</title>
  <indexterm zone="Laminax-js-{prefix}-{name}-signal"><primary>{prefix}::{name}</primary></indexterm>
  <programlisting language="javascript">
...
PROPERTIES_FORMAT = '''
<refsect1 id="Laminax-js-{prefix}.property-details" role="property_details">
...
<refsect2 id="Laminax-js-{prefix}--{name}" role="property">
  <title>The <literal>“{name}”</literal> property</title>
  <indexterm zone="Laminax-js-{prefix}--{name}">
    <primary>Laminax-js-{prefix}:{name}</primary>
  </indexterm>
...
ENUMS_FORMAT = '''
<refsect1 id="LaminaxGlobal.other_details" role="details">
...
ENUMS_ITEM_FORMAT = '''
<refsect2 id="Laminax-js-{prefix}" role="enum">
