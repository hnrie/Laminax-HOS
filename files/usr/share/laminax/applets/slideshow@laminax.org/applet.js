...
class LaminaxSlideshowApplet extends Applet.IconApplet {
    constructor(metadata, orientation, panel_height, instanceId) {
        super(orientation, panel_height, instanceId);

        this._slideshowSettings = new Gio.Settings({ schema_id: "org.Laminax.desktop.background.slideshow" });
        this._backgroundSettings = new Gio.Settings({ schema_id: "org.Laminax.desktop.background" });
        ...
        this.open_settings_context_menu_item.connect('activate', Lang.bind(this, function() {
            Util.spawnCommandLine("Laminax-settings backgrounds");
        }));
...
function main(metadata, orientation, panel_height, instanceId) {
    return new LaminaxSlideshowApplet(metadata, orientation, panel_height, instanceId);
}
