 ...
 * LaminaxGenericContainer.  We manage the allocation ourselves and shrink the
...
class AppMenuButton {
    constructor(applet, metaWindow, transient) {
        ...
        this._iconBox = new Laminax.Slicer({ name: 'appMenuIcon' });
...
class LaminaxWindowListApplet extends Applet.Applet {
    constructor(orientation, panel_height, instance_id) {
        ...
        this.settings = new Settings.AppletSettings(this, "window-list@Laminax.org", this.instance_id);
        ...
        this.signals.connect(Laminax.WindowTracker.get_default(), "window-app-changed", this._onWindowAppChanged, this);
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LaminaxWindowListApplet(orientation, panel_height, instance_id);
}
