...
const Gettext = imports.gettext.domain("Laminax-applets");
const Util = imports.misc.util;

const PANEL_EDIT_MODE_KEY = "panel-edit-mode";

class LaminaxNotificationsApplet extends Applet.TextIconApplet {
...
function main(metadata, orientation, panel_height, instanceId) {
    return new LaminaxNotificationsApplet(metadata, orientation, panel_height, instanceId);
}
...
function timeify(orig_time) {
    let settings = new Gio.Settings({schema_id: 'org.Laminax.desktop.interface'});
