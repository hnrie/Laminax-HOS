...
class LaminaxSettingsExampleApplet extends Applet.TextIconApplet {
    constructor(orientation, panel_height, instance_id) {
        ...
        this.settings = new Settings.AppletSettings(this, "settings-example@Laminax.org", instance_id);
...
function main(metadata, orientation, panel_height, instance_id) {  // Make sure you collect and pass on instanceId
    return new LaminaxSettingsExampleApplet(orientation, panel_height, instance_id);
}
