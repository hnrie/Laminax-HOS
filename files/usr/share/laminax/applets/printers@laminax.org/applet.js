...
const APPLET_PATH = imports.ui.appletManager.appletMeta['printers@Laminax.org'].path;


class LaminaxPrintersApplet extends Applet.TextIconApplet {
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LaminaxPrintersApplet(metadata, orientation, panel_height, instance_id);
}
