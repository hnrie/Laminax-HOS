...
const DAY_FORMAT = LaminaxDesktop.WallClock.lctime_format("Laminax", "%A");
const DATE_FORMAT_SHORT = LaminaxDesktop.WallClock.lctime_format("Laminax", _("%B %-e, %Y"));
const DATE_FORMAT_FULL = LaminaxDesktop.WallClock.lctime_format("Laminax", _("%A, %B %-e, %Y"));

class LaminaxCalendarApplet extends Applet.TextApplet {
    constructor(orientation, panel_height, instance_id) {
        ...
        try {
            ...
            this.settings = new Settings.AppletSettings(this, "calendar@Laminax.org", this.instance_id);
            this.desktop_settings = new Gio.Settings({ schema_id: "org.Laminax.desktop.interface" });

            this.clock = new LaminaxDesktop.WallClock();
    ...
    on_custom_format_button_pressed() {
        Util.spawnCommandLine("xdg-open https://Laminax-spices.linuxmint.com/strftime.php");
    }

    _onLaunchSettings() {
        this.menu.close();
        Util.spawnCommandLine("Laminax-settings calendar");
    }
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LaminaxCalendarApplet(orientation, panel_height, instance_id);
}
