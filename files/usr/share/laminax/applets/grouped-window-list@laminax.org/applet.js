...
class GroupedWindowListApplet extends Applet.Applet {
    constructor(metadata, orientation, panel_height, instance_id) {
        ...
        this.tracker = Laminax.WindowTracker.get_default();
        ...
        this.state.connect({
            ...
            getAppSystem: () => Laminax.AppSystem.get_default(),
    ...
    // TODO: Figure out exactly which properties on this applet constructor the Laminax APIs needs for all modes of
    // DND, so we can kill the _delegate reference. Long term, a PR to Laminax should be opened fixing circular
    ...
    moveLauncher(source) {
        ...
        Meta.later_add(Meta.LaterType.BEFORE_REDRAW, () => {
            ...
            // In the case of dragging a group that has a delay before Laminax can grab its
