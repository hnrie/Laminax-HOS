...
class AppGroup {
    constructor(params) {
        ...
        this.iconBox = new Laminax.Slicer({name: 'appMenuIcon'});
    ...
    allocate(actor, box, flags) {
        ...
        // Call set_icon_geometry for support of Laminax's minimize animation
    ...
    onAppButtonRelease(actor, event) {
        ...
        const modifiers = Laminax.get_event_state(event);
