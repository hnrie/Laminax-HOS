...
const Laminax_DESKTOP_SOUNDS = "org.Laminax.desktop.sound";
...
class LaminaxSoundApplet extends Applet.TextIconApplet {
    constructor(metadata, orientation, panel_height, instanceId) {
        ...
        this._control = new Cvc.MixerControl({ name: 'Laminax Volume Control' });
        ...
        this._sound_settings = new Gio.Settings({ schema_id: Laminax_DESKTOP_SOUNDS });
...
function main(metadata, orientation, panel_height, instanceId) {
    return new LaminaxSoundApplet(metadata, orientation, panel_height, instanceId);
}
