...
class LaminaxSpacerApplet extends Applet.Applet {
    constructor(metadata, orientation, panelHeight, instance_id) {
        ...
        this.settings = new Settings.AppletSettings(this, "spacer@Laminax.org", this.instance_id);
...
function main(metadata, orientation, panelHeight, instance_id) {
    return new LaminaxSpacerApplet(metadata, orientation, panelHeight, instance_id);
}
