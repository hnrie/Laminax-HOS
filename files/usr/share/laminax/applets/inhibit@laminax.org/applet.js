...
class InhibitSwitch extends PopupMenu.PopupBaseMenuItem {
    ...
    toggled(active) {
        if (!active && !this.sessionCookie) {
            this.sessionProxy.InhibitRemote("inhibit@Laminax.org",
                0,
...
class LaminaxInhibitApplet extends Applet.IconApplet {
    constructor(metadata, orientation, panel_height, instanceId) {
        ...
        this.notif_settings = new Gio.Settings({ schema_id: "org.Laminax.desktop.notifications" });
    ...
    on_btn_open_system_power_settings_clicked() {
        Util.spawnCommandLine("Laminax-settings power");
    }

    on_btn_open_system_notification_settings_clicked() {
        Util.spawnCommandLine("Laminax-settings notifications");
    }
...
function main(metadata, orientation, panel_height, instanceId) {
    return new LaminaxInhibitApplet(metadata, orientation, panel_height, instanceId);
}
