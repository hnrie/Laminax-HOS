...
const USER_DEFAULT_IMG_PATH = "/usr/share/Laminax/faces/user-generic.png";

class LaminaxUserApplet extends Applet.TextApplet {
    constructor(orientation, panel_height, instance_id) {
        ...
        this.settings = new Settings.AppletSettings(this, "user@Laminax.org", instance_id);
        ...
        item.connect('activate', Lang.bind(this, function() {
            Util.spawnCommandLine("Laminax-settings");
        }));
        ...
        let lockdown_settings = new Gio.Settings({ schema_id: 'org.Laminax.desktop.lockdown' });
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LaminaxUserApplet(orientation, panel_height, instance_id);
}
