...
class LaminaxPanelLaunchersApplet extends Applet.Applet {
    ...
    showAddLauncherDialog(timestamp, launcher){
        if (launcher) {
            Util.spawnCommandLine("Laminax-desktop-editor -mLaminax-launcher --icon-size %d -f %s %s"
                .format(this.icon_size, launcher.getId(), this.settings.file.get_path()));
        } else {
            Util.spawnCommandLine("Laminax-desktop-editor -mLaminax-launcher --icon-size %d %s"
...
Signals.addSignalMethods(LaminaxPanelLaunchersApplet.prototype);

function main(metadata, orientation, panel_height, instance_id) {
    return new LaminaxPanelLaunchersApplet(metadata, orientation, panel_height, instance_id);
}
