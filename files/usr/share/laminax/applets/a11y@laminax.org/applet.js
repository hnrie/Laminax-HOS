...
const A11Y_KEYBOARD_SCHEMA = 'org.Laminax.desktop.a11y.keyboard';
const A11Y_MOUSE_SCHEMA = 'org.Laminax.desktop.a11y.mouse';
...
const DESKTOP_INTERFACE_SCHEMA = 'org.Laminax.desktop.interface';
const KEY_GTK_THEME      = 'gtk-theme';
const KEY_ICON_THEME     = 'icon-theme';
const KEY_TEXT_SCALING_FACTOR = 'text-scaling-factor';

const WM_PREFERENCES_SCHEMA  = 'org.Laminax.desktop.wm.preferences';
...
class LaminaxA11YApplet extends Applet.TextIconApplet {
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LaminaxA11YApplet(metadata, orientation, panel_height, instance_id);
}
