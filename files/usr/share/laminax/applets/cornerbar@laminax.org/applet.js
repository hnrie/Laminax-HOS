...
class LaminaxBarApplet extends Applet.Applet {
    constructor(orientation, panel_height, instance_id) {
        super(orientation, panel_height, instance_id);
        this.muffinSettings = new Gio.Settings({ schema_id: 'org.Laminax.muffin' });
        this.settings = new Settings.AppletSettings(this, "cornerbar@Laminax.org", instance_id);
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LaminaxBarApplet(orientation, panel_height, instance_id);
}
