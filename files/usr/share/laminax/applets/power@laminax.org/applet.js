...
const BrightnessBusName = "org.Laminax.SettingsDaemon.Power.Screen";
const KeyboardBusName = "org.Laminax.SettingsDaemon.Power.Keyboard";
...
class LaminaxPowerApplet extends Applet.TextIconApplet {
    constructor(metadata, orientation, panel_height, instanceId) {
        ...
        this.csd_power_watch_id = Gio.bus_watch_name(Gio.BusType.SESSION, "org.Laminax.SettingsDaemon.Power", 0, (c, name) => {
            Interfaces.getDBusProxyAsync("org.Laminax.SettingsDaemon.Power", Lang.bind(this, function (proxy, error) {
...
function main(metadata, orientation, panel_height, instanceId) {
    return new LaminaxPowerApplet(metadata, orientation, panel_height, instanceId);
}
