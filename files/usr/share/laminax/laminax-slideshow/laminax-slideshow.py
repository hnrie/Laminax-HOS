...
SLIDESHOW_DBUS_NAME = "org.Laminax.Slideshow"
SLIDESHOW_DBUS_PATH = "/org/Laminax/Slideshow"
...
class LaminaxSlideshowApplication(Gio.Application):
    def __init__(self):
        super().__init__(
        ...
        self.slideshow_settings = Gio.Settings(schema="org.Laminax.desktop.background.slideshow")
        self.background_settings = Gio.Settings(schema="org.Laminax.desktop.background")
...
if __name__ == "__main__":
    setproctitle("Laminax-slideshow")

    app = LaminaxSlideshowApplication()
    app.run()