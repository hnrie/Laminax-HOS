...
LG_DBUS_NAME = "org.Laminax.LookingGlass"
LG_DBUS_PATH = "/org/Laminax/LookingGlass"
...
class LookingGlassProxy(GObject.Object):
    ...
    def init_proxy(self):
        try:
            ...
            print("Could not establish proxy with Laminax looking-glass interface: %s" % e.message)
            self._proxy = None
