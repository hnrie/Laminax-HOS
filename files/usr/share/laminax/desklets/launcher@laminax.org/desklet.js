...
const CUSTOM_LAUNCHERS_PATH = GLib.get_user_data_dir() + "/Laminax/panel-launchers/";
const OLD_CUSTOM_LAUNCHERS_PATH = GLib.get_home_dir() + '/.Laminax/panel-launchers/';

const ICON_SIZE = 48;
const ANIM_ICON_SIZE = 40;

class LaminaxLauncherDesklet extends Desklet.Desklet {
    constructor(metadata, desklet_id) {
        super(metadata, desklet_id);
        this._launcherSettings = new Gio.Settings({schema_id: 'org.Laminax.desklets.launcher'});
        ...
        this._menu.addAction(
            ...
            Lang.bind(this, function() {
                Util.spawnCommandLine('/usr/share/Laminax/desklets/launcher@Laminax.org/editorDialog.py ' + this.instance_id);
            })
        );
    ...
    _getApp() {
        ...
        // No desktop file found; Default to 'Laminax-settings.desktop'
        return appSys.lookup_app('Laminax-settings.desktop');
    }
...
function main(metadata, desklet_id) {
    return new LaminaxLauncherDesklet(metadata, desklet_id);
}
