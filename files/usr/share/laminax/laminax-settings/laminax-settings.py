...
# i18n
gettext.install("Laminax", "/usr/share/locale", names=["ngettext"])
...
STANDALONE_MODULES = [
    ...
    [_("Driver Manager"),             "Laminax-driver-manager",              "cs-drivers",                "admin",      _("video, driver, wifi, card, hardware, proprietary, nvidia, radeon, nouveau, fglrx")],
    ...
    [_("Users and Groups"),           "Laminax-settings-users",              "cs-user-accounts",          "admin",      _("user, users, account, accounts, group, groups, password")],
...
class MainWindow(Gio.Application):
    ...
    def __init__(self, parsed_args):
        Gio.Application.__init__(self,
                                 application_id=f"org.Laminax.Settings_{os.getpid()}",
                                 flags=Gio.ApplicationFlags.NON_UNIQUE | Gio.ApplicationFlags.HANDLES_OPEN)
        self.builder = Gtk.Builder()
        self.builder.set_translation_domain('Laminax')  # let it translate!
        self.builder.add_from_file(os.path.join(CURRENT_PATH, "Laminax-settings.ui"))
    ...
    def load_sidepage_as_standalone(self, args) -> bool:
        ...
        wm_class = f"Laminax-settings {args.module}"
    ...
    def load_ccc_modules(self):
        """Loads all Laminax Control Center settings modules."""
...
To see a list of available tabs for a specific module, use `Laminax-settings MODULE --tab help`
...
SORT_TYPE can be specified by number or name as follows:
    ...
    parser = argparse.ArgumentParser(
        description="Laminax-settings - Configuration tool for Laminax",
        epilog=EPILOG,
