...
class Module:
    ...
    def on_module_selected(self):
        ...
        schema = "org.Laminax.desktop.screensaver"
        ...
        widget = GSettingsComboBox(_("Delay before starting the screensaver"), "org.Laminax.desktop.session", "idle-delay", LOCK_INACTIVE_OPTIONS, valtype=int, size_group=size_group)
        ...
        widget = GSettingsSwitch(_("Lock the computer when put to sleep"), "org.Laminax.settings-daemon.plugins.power", "lock-on-suspend")
        ...
        widget = GSettingsFontButton(_("Time Font"), "org.Laminax.desktop.screensaver", "font-time", size_group=size_group)
        settings.add_row(widget)

        widget = GSettingsFontButton(_("Date Font"), "org.Laminax.desktop.screensaver", "font-date", size_group=size_group)
        settings.add_row(widget)
        ...
        settings.add_row(GSettingsFontButton(_("Font"), "org.Laminax.desktop.screensaver", "font-message"))
