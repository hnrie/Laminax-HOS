...
CSD_SCHEMA = "org.Laminax.settings-daemon.plugins.power"
CSM_SCHEMA = "org.Laminax.SessionManager"
...
class Module:
    ...
    def on_module_selected(self):
        ...
        self.csd_power_proxy = Gio.DBusProxy.new_sync(
            ...
            None,
            "org.Laminax.SettingsDaemon.Power",
            "/org/Laminax/SettingsDaemon/Power",
            "org.Laminax.SettingsDaemon.Power",
            None)
        ...
        proxy = Gio.DBusProxy.new_sync(
            ...
            "org.Laminax.SettingsDaemon.Power",
            "/org/Laminax/SettingsDaemon/Power",
            "org.Laminax.SettingsDaemon.Power.Screen",
            None)
        ...
        try:
            ...
            proxy = Gio.DBusProxy.new_sync(Gio.bus_get_sync(Gio.BusType.SESSION, None),
                                           ...
                                           "org.Laminax.SettingsDaemon.Power",
                                           "/org/Laminax/SettingsDaemon/Power",
                                           "org.Laminax.SettingsDaemon.Power.Keyboard",
                                           None)
