...
Laminax_SOUNDS = "org.Laminax.sounds"
Laminax_DESKTOP_SOUNDS = "org.Laminax.desktop.sound"
OVERAMPLIFICATION_KEY = "allow-amplified-volume"

DECAY_STEP = .15

EFFECT_LIST = [
    {"label": _("Starting Laminax"),           "schema": Laminax_SOUNDS,         "file": "login-file",        "enabled": "login-enabled"},
    {"label": _("Leaving Laminax"),            "schema": Laminax_SOUNDS,         "file": "logout-file",       "enabled": "logout-enabled"},
    {"label": _("Switching workspace"),         "schema": Laminax_SOUNDS,         "file": "switch-file",       "enabled": "switch-enabled"},
    {"label": _("Opening new windows"),         "schema": Laminax_SOUNDS,         "file": "map-file",          "enabled": "map-enabled"},
    {"label": _("Closing windows"),             "schema": Laminax_SOUNDS,         "file": "close-file",        "enabled": "close-enabled"},
    {"label": _("Minimizing windows"),          "schema": Laminax_SOUNDS,         "file": "minimize-file",     "enabled": "minimize-enabled"},
    {"label": _("Maximizing windows"),          "schema": Laminax_SOUNDS,         "file": "maximize-file",     "enabled": "maximize-enabled"},
    {"label": _("Unmaximizing windows"),        "schema": Laminax_SOUNDS,         "file": "unmaximize-file",   "enabled": "unmaximize-enabled"},
    {"label": _("Tiling and snapping windows"), "schema": Laminax_SOUNDS,         "file": "tile-file",         "enabled": "tile-enabled"},
    {"label": _("Inserting a device"),          "schema": Laminax_SOUNDS,         "file": "plug-file",         "enabled": "plug-enabled"},
    {"label": _("Removing a device"),           "schema": Laminax_SOUNDS,         "file": "unplug-file",       "enabled": "unplug-enabled"},
    {"label": _("Showing notifications"),       "schema": Laminax_SOUNDS,         "file": "notification-file", "enabled": "notification-enabled"},
    {"label": _("Changing the sound volume"),   "schema": Laminax_DESKTOP_SOUNDS, "file": "volume-sound-file", "enabled": "volume-sound-enabled"}
]
...
class Module:
    ...
    def __init__(self, content_box):
        ...
        self.sound_settings = Gio.Settings(Laminax_DESKTOP_SOUNDS)
    ...
    def buildLayout(self):
        ...
        # overamplification
        switch = GSettingsSwitch(_("Overamplification"), Laminax_DESKTOP_SOUNDS, OVERAMPLIFICATION_KEY)
    ...
    def inializeController(self):
        self.controller = Cvc.MixerControl(name = "Laminax")
    ...
    def streamAdded(self, c, deviceId):
        ...
        if stream in self.controller.get_sink_inputs():
            ...
            if name in ("Laminax-settings.py",
                        "speech-dispatcher",
                        "speech-dispatcher-dummy",
                        "libcanberra",
                        "Muffin"):
                # Laminax-settings.py: test sounds
                # speech-dispatcher[-dummy]: orca/speechd/spd-say
                # libcanberra: Laminax effects, test sounds - don't think this is needed any more?
                # Muffin: window effects, some other Laminax effects.
                return
