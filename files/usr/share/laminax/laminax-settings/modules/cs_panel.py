...
class PanelSettingsPage(SettingsPage):
    def __init__(self, panel_id, settings, position):
        ...
        widget = PanelComboBox(_("Auto-hide panel"), "org.Laminax", "panels-autohide", self.panel_id, options, size_group=self.size_group)
        section.add_row(widget)

        widget = PanelSpinButton(_("Show delay"), "org.Laminax", "panels-show-delay", self.panel_id, _("milliseconds"), 0, 2000, 50, 200)#, dep_key="org.Laminax/panels-autohide")
        section.add_reveal_row(widget, "org.Laminax", "panels-autohide", check_func=can_show)

        widget = PanelSpinButton(_("Hide delay"), "org.Laminax", "panels-hide-delay", self.panel_id, _("milliseconds"), 0, 2000, 50, 200)#, dep_key="org.Laminax/panels-autohide")
        section.add_reveal_row(widget, "org.Laminax", "panels-autohide", check_func=can_show)

        section = SettingsSection(_("Customize"))
        self.add(section)

        widget = PanelRange(dimension_text, "org.Laminax", "panels-height", self.panel_id, _("Smaller"), _("Larger"), mini=20, maxi=60, digits=0, step=1.0, show_value=True)
    ...
    def create_zone_page(self, zone):
        ...
        widget = PanelJSONComboBox(_("Font size"),
                                     "org.Laminax", "panel-zone-text-sizes",
        ...
        widget = PanelJSONComboBox(_("Colored icon size"),
                                   "org.Laminax", "panel-zone-icon-sizes",
        ...
        widget = PanelJSONSpinButton(_("Symbolic icon size"),
                                     "org.Laminax", "panel-zone-symbolic-icon-sizes",
...
class Module:
    name = "panel"
    category = "prefs"
    comment = _("Manage Laminax panel settings")
    ...
    def on_module_selected(self):
        if not self.loaded:
            ...
            self.settings = Gio.Settings.new("org.Laminax")
            ...
            section.add_row(GSettingsSwitch(_("Allow the pointer to pass through the edges of panels"), "org.Laminax", "no-adjacent-panel-barriers"))
