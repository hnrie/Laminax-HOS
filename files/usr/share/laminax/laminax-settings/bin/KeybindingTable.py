...
gettext.install("Laminax", "/usr/share/locale")
...
CUSTOM_KEYS_PARENT_SCHEMA = "org.Laminax.desktop.keybindings"
CUSTOM_KEYS_BASENAME = "/org/Laminax/desktop/keybindings/custom-keybindings"
CUSTOM_KEYS_SCHEMA = "org.Laminax.desktop.keybindings.custom-keybinding"

MUFFIN_KEYBINDINGS_SCHEMA = "org.Laminax.desktop.keybindings.wm"
MEDIA_KEYS_SCHEMA = "org.Laminax.desktop.keybindings.media-keys"
Laminax_SCHEMA = "org.Laminax.desktop.keybindings"
ENABLED_SCHEMA = "org.Laminax"

OLD_SETTINGS_DIR = Path.joinpath(Path.home(), ".Laminax/configs/")
SETTINGS_DIR = Path.joinpath(Path.home(), ".config/Laminax/spices/")
...
[
  [_("General"), "general", None, "preferences-desktop-keyboard-shortcuts",
    [
      [_("Pointer"), "pointer", "general", None, [],
        [
          [_("Move pointer to the next monitor"), Laminax_SCHEMA, "pointer-next-monitor"],
          [_("Move pointer to the previous monitor"), Laminax_SCHEMA, "pointer-previous-monitor"]
        ]
      ],
      [_("Troubleshooting"), "trouble", "general", None, [],
        [
          [_("Toggle Looking Glass"), Laminax_SCHEMA, "looking-glass-keybinding"]
        ]
      ]
    ],
    [
      ...
      [_("Show Desklets"), Laminax_SCHEMA, "show-desklets"],
    ...
    [
      ...
      [_("Screenshots and Recording"), "sys-screen", "system", None, [],
        [
          ...
          [_("Toggle recording desktop (must restart Laminax)"), MUFFIN_KEYBINDINGS_SCHEMA, "toggle-recording"]
        ]
      ]
    ],
    [
      ...
      [_("Restart Laminax"), MEDIA_KEYS_SCHEMA, "restart-Laminax"]
    ]
  ],
  ...
  [_("Universal Access"), "accessibility", None, "preferences-desktop-accessibility", [],
    [
      [_("Zoom in"), Laminax_SCHEMA, "magnifier-zoom-in"],
      [_("Zoom out"), Laminax_SCHEMA, "magnifier-zoom-out"],
      [_("Reset zoom"), Laminax_SCHEMA, "magnifier-zoom-reset"],
...
class CustomKeyBinding(GObject.Object):
    ...
    def writeSettings(self, emit_changed=False):
        ...
        # Touch the custom-list key, this will trigger a rebuild in Laminax
...
class KeybindingTable(GObject.Object):
    ...
    def __init__(self):
        ...
        try:
            Gio.DBusProxy.new_for_bus(
                ...
                None,
                "org.Laminax", "/org/Laminax", "org.Laminax",
    ...
    def _on_proxy_ready(self, obj, result, data=None):
        try:
            ...
            print(f"KeybindingTable could not establish proxy for org.Laminax: {e}")
    ...
    def _load_spice_store(self):
        ...
        for spice, bindings in spice_keybinds.items():
            ...
            local_metadata_path = Path.home() / '.local/share/Laminax' / _type / uuid / 'metadata.json'
            if local_metadata_path.exists():
                ...
                system_metadata_path = Path("/usr/share/Laminax") / _type / uuid / "metadata.json"
    ...
    def _load_custom_store(self):
        ...
        cat = KeyBindingCategory(_("Custom Shortcuts"), "custom", None, "Laminax-panel-launcher")
