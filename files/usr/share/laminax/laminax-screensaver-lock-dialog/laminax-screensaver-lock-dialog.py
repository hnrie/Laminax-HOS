...
class MainWindow:
    ...
    def __init__(self):
        ...
        self.builder.add_from_file("/usr/share/Laminax/Laminax-screensaver-lock-dialog/Laminax-screensaver-lock-dialog.ui")
    ...
    def lock_screen(self, data):
        ...
        if message != "":
            subprocess.call(["Laminax-screensaver-command", "--lock", "--away-message", self.entry.get_text()])
        else:
            subprocess.call(["Laminax-screensaver-command", "--lock"])
        Gtk.main_quit()

if __name__ == "__main__":
    setproctitle("Laminax-screensaver-lock-dialog")
    MainWindow()
    Gtk.main()
