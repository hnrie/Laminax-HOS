...
gi.require_version('Laminax', '0.1')
from gi.repository import GLib, Gio, GObject
from gi.repository import EDataServer, ECal, ICal, ICalGLib
from gi.repository import Laminax

BUS_NAME = "org.Laminax.CalendarServer"
BUS_PATH = "/org/Laminax/CalendarServer"
...
class CalendarServer(Gio.Application):
    def __init__(self, hold=False):
        ...
        self.interface = Laminax.CalendarServerSkeleton.new()
...
def main():
    setproctitle("Laminax-calendar-server")
